...
public class ClanFunctionTest {
    ...
    public void testFillTable(){
       ...
       //De array zou als 2e resultaat Mboiz2 moeten hebben
       assertEquals("Mboiz2",result.get(1));      
    }
    ...
    public void testHandleManagement(){
        ...
        //Als Sven opnieuw probeert te rejecten kan dit niet omdat de invatation al is rejected
        assertFalse(clanFunctions.handleManagement(ManagementType.REJECT, "MBoiz", "svenke@gmail.com"));
        //Als sven een clan probeert te removen waarvan hij niet de leider is zal dit false returnen
        assertFalse(clanFunctions.handleManagement(ManagementType.REMOVE, "MBoiz", "svenke@gmail.com"));
        //Als Jip dit probeert zou dit wel moeten lukken en moet er false worden returned
        assertTrue(clanFunctions.handleManagement(ManagementType.REMOVE, "MBoiz", "jip.vandevijfeike@gmail.com"));
    }
    //2e assert werkt nog niet goed
}
